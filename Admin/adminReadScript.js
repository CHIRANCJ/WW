...
async function fetchInventory(isAdmin = false) {
    try {
        const response = await fetch(`https://firestore.googleapis.com/v1/projects/login-passwordd/databases/(default)/documents/inventory`);
...
async function toggleItemStatus(itemId, isActive) {
    ...
    const updateUrl = `https://firestore.googleapis.com/v1/projects/login-passwordd/databases/(default)/documents/inventory/${itemId}?updateMask.fieldPaths=IsActive`;
...
async function fetchUsers() {
            const url = `https://firestore.googleapis.com/v1/projects/login-passwordd/databases/(default)/documents/users`;
        ...
        async function updateCreditLimit(userId) {
            ...
            const updateUrl = `https://firestore.googleapis.com/v1/projects/login-passwordd/databases/(default)/documents/users/${userId}?updateMask.fieldPaths=CreditLimit`;
